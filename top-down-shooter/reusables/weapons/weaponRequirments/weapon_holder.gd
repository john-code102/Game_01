extends Node2D 
#Expanding on the directory idea if you use a export var of the weapons directory you 
#could loop over all the different gun scenes and create and inventory or weapon
#switcher or smthin easliy. Then we could reuse it on enemies etc as well. Just
#a thought. I dont have time to look over this code so if someone could comment this out 
